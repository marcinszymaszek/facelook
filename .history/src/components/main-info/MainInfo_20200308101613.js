        ...
        <div className="inline-container">
            <div className="inner-box">
                ...
                {numberOfUsers === "count em :)" ?
                    <span className="icon"><EyeSolidIcon className="eye-icon" onClick={() => handleClick()} /></span> :
                    <span className="icon"><EyeSlashSolidIcon className="eye-icon" onClick={() => handleClick()} /></span>}
            </div>
        </div>
    )
}
